...
//code for validation of fields goes here
                                ...
                                $querys = mysqli_query("select  * from tbladmin where email ='$email'") or die(mysqli_error());
                    ...
                    $result =  mysqli_query("insert into tbladmin (email,username,password,role,RegCentre,dateReg)
