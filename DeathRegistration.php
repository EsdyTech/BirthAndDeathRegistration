...
//code for validation of fields goes here
                   ...
                   $firstName = $_POST['firstName'];
                          ...
                          $query = mysqli_query("select  * from tblcertno where certId = '200000'") or die(mysqli_error());
                          $row = mysqli_fetch_array($query);
                          $numberOfRows = mysqli_num_rows($query);				
      
                         $newCertNo  = $row['lastCertId']  + 1;  
  
     $resultt = mysqli_query("update tblcertno set lastCertId='$newCertNo' where certId = '200000'") or die(mysqli_query());
  
                         if($resultt > 0){
                                    


                    $result =  mysqli_query("insert into tbldeath (certNo,firstName,lastName,gender,state,lga,address,ageAtDeath,placeOfDeath,dateOfDeath,PlaceOfIssue,regCentre,dateReg)
