                ...
                <div class="card-body">
                  ...
                  <div class="chart-container">
                    <canvas id="dashboard-area-chart" height="80"></canvas>
                       ...
                       $query = mysqli_query("select  * from tblbirth where birthId = '$_SESSION[birthRegId]'") or die(mysqli_error());
