...
$query = mysqli_query("select  * from tblcentre where centreId = '$_SESSION[centreRegId]'") or die(mysqli_error());
$row = mysqli_fetch_array($query);
   ...
   ?>
      ...
      $resultt = mysqli_query("update tblcentre set centreName ='$centreName',state='$state',lga='$lga',dateReg='$dateReg' where centreId = '$_SESSION[centreRegId]'") or die(mysqli_error());
